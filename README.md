...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/languages-EN%20%7C%20RU%20%7C%20KK%20%7C%20ZH-orange?style=flat-square" alt="Languages">
</p>
...
- main HUD during normal gameplay;
- F10 settings / edit mode;
- world timer on a beehive, fermenter or smelter;
- language selector;
- custom HUD layout.
...
Inject0r HUD is released under the [MIT License](LICENSE).
